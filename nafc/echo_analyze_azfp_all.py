...
# Daily averages
dds = ds.resample(ping_time='1D').mean()
dds2 = ds2.resample(ping_time='1D').mean()

# Select a depth range
dds = dds.sel(range_bin=dds['range_bin']<=166)
dds = dds.sel(range_bin=dds['range_bin']>=5)
dds2 = dds2.sel(range_bin=dds2['range_bin']<=100)
dds2 = dds2.sel(range_bin=dds2['range_bin']>=5)
# Select frequency
ds_38 = dds.sel(frequency=dds['frequency']==38000.0).squeeze()
ds_67 = dds.sel(frequency=dds['frequency']==67000.0).squeeze()
ds_125 = dds.sel(frequency=dds['frequency']==125000.0).squeeze()
ds_200 = dds.sel(frequency=dds['frequency']==200000.0).squeeze()
ds_200_2 = dds2.sel(frequency=dds2['frequency']==200000.0).squeeze()
ds_333 = dds2.sel(frequency=dds2['frequency']==333000.0).squeeze()
ds_455 = dds2.sel(frequency=dds2['frequency']==455000.0).squeeze()
...
fig_name = 'AZFP_Sv_clean_all.png'
