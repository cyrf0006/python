...
azu.get_bottomT_climato('/home/cyrf0006/data/dev_database/netCDF/*.nc', lon_reg, lat_reg, season='fall', year_lims=[1995, 2018], h5_outputfile='Tbot_1995-2018_fall_0.10.h5')
...
## ---- Load Climato data ---- ##    
if period == 0:
    climato_file = '/home/cyrf0006/AZMP/state_reports/bottomT/Tbot_1995-2018_fall_0.10.h5'
elif period == 1:
    climato_file = '/home/cyrf0006/AZMP/state_reports/bottomT/Tbot_1995-2001_fall_0.10.h5'
elif period == 2:
    climato_file = '/home/cyrf0006/AZMP/state_reports/bottomT/Tbot_2002-2006_fall_0.10.h5'
elif period == 3:
    climato_file = '/home/cyrf0006/AZMP/state_reports/bottomT/Tbot_2007-2013_fall_0.10.h5'
elif period == 4:
    climato_file = '/home/cyrf0006/AZMP/state_reports/bottomT/Tbot_2014-2018_fall_0.10.h5'
...
c = plt.contourf(lon_reg, lat_reg, Tbot_climato, levels, transform=ccrs.PlateCarree(), cmap=plt.cm.RdBu_r, extend='both', zorder=5)
c0 = plt.contour(lon_reg, lat_reg, Tbot_climato, [0,], transform=ccrs.PlateCarree(), colors='k', zorder=5)
cc = plt.contour(lon_reg, lat_reg, -Zitp, [100, 500, 1000, 2000, 3000, 4000], colors='silver', linewidths=1, transform=ccrs.PlateCarree(), zorder=10)
plt.clabel(cc, inline=True, fontsize=7, fmt='%i')
if period == 0:
    plt.title('Bottom Temperature - 1995-2018 average')
elif period == 1:
    plt.title('Bottom Temperature - 1995-2001 average')
elif period == 2:   
    plt.title('Bottom Temperature - 2002-2006 average')
elif period == 3:
    plt.title('Bottom Temperature - 2007-2013 average')
elif period == 4:    
    plt.title('Bottom Temperature - 2014-2018 average')
...
if period == 0:
    outfile = 'bottom_temp_1995-2018_' + season + '.png'
elif period == 1:
    outfile = 'bottom_temp_1995-2001_' + season + '.png'
elif period == 2:
    outfile = 'bottom_temp_2002-2006_' + season + '.png'
elif period == 3:
    outfile = 'bottom_temp_2007-2013_' + season + '.png'
elif period == 4:
    outfile = 'bottom_temp_2014-2018_' + season + '.png'
