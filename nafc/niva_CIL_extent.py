...
## ---- Load Climato data ---- ##    
if period == 0:
    climato_file = '/home/cyrf0006/research/Niva/TCIL_1995-2018_fall_0.10.h5'
elif period == 1:
    climato_file = '/home/cyrf0006/research/Niva/TCIL_1995-2001_fall_0.10.h5'
elif period == 2:
    climato_file = '/home/cyrf0006/research/Niva/TCIL_2002-2006_fall_0.10.h5'
elif period == 3:
    climato_file = '/home/cyrf0006/research/Niva/TCIL_2007-2013_fall_0.10.h5'
elif period == 4:
    climato_file = '/home/cyrf0006/research/Niva/TCIL_2014-2018_fall_0.10.h5'
    
h5f = h5py.File(climato_file, 'r')
Tcil_climato = h5f['Tcil'][:]
lon_reg = h5f['lon_reg'][:]
lat_reg = h5f['lat_reg'][:]
Zitp = h5f['Zitp'][:]
h5f.close()
...
ls = np.linspace(0, 5500, 7)
levels = np.linspace(-2, 0, 11)
c = plt.contourf(lon_reg, lat_reg, Tcil_climato, levels, transform=ccrs.PlateCarree(), cmap=plt.cm.Blues_r, zorder=5)
c0 = plt.contour(lon_reg, lat_reg, Tcil_climato, [0,], transform=ccrs.PlateCarree(), colors='k', zorder=5)
...
if period == 0:
    plt.title('CIL average temperature - 1995-2018 average')
elif period == 1:
    plt.title('CIL average temperature - 1995-2001 average')
elif period == 2:   
    plt.title('CIL average temperature - 2002-2006 average')
elif period == 3:
    plt.title('CIL average temperature - 2007-2013 average')
elif period == 4:    
    plt.title('CIL average temperature - 2014-2018 average')
...
if period == 0:
    outfile = 'CIL_temp_1995-2018_' + season + '.png'
elif period == 1:
    outfile = 'CIL_temp_1995-2001_' + season + '.png'
elif period == 2:
    outfile = 'CIL_temp_2002-2006_' + season + '.png'
elif period == 3:
    outfile = 'CIL_temp_2007-2013_' + season + '.png'
elif period == 4:
    outfile = 'CIL_temp_2014-2018_' + season + '.png'
