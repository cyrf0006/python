'''
Attempt to plot a climatological map, but not working at the moment...
'''
...
ds = xr.open_mfdataset('/media/cyrf0006/Seagate Backup Plus Drive/SST_NOAA/sst.day.mean.2*.nc', combine='by_coords')
print(' -> Done!')
...
df_col = df_col[df_col.index.month==9]
# HERE!!!
