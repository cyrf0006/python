...
# Custom polygons
## khanh1 = 
## Box 1 (59014’N, 50E; 59014’N, 40E; 58014’N, 50E; 58014’N, 40E)
## Box 2 (69047’N, 180E; 69047’N, 17030’E; 70030’N, 180E; 70030’N, 17030’E)
...
# METHOD 1 - Works but long
    ...
    for i,sst in enumerate(df_col.sst.values):
        ...
        if polygon3.contains(point) | polygon4.contains(point) | polygon5.contains(point) | polygon6.contains(point):
            ...
            idx_W.append(i)
        elif polygon14A.contains(point):
            idx_14A.append(i)
        elif polygon14B.contains(point):
            idx_14B.append(i)
        elif polygon14C.contains(point):
            idx_14C.append(i)
    ...
    df_14A = df_col.iloc[idx_14A]
    df_14B = df_col.iloc[idx_14B]
    df_14C = df_col.iloc[idx_14C]
    ...
    df_14A.to_pickle('sst_lfa14A_method1.pkl')
    df_14B.to_pickle('sst_lfa14B_method1.pkl')
    df_14C.to_pickle('sst_lfa14C_method1.pkl')
    ...
    df_14A.to_pickle('sst_lfa14A_method2.pkl')
    df_14B.to_pickle('sst_lfa14B_method2.pkl')
    df_14C.to_pickle('sst_lfa14C_method2.pkl')
...
if METHOD == 1:
    ...
    df_14A = pd.read_pickle('sst_lfa14A_method2.pkl')
    df_14B = pd.read_pickle('sst_lfa14B_method2.pkl')
    df_14C = pd.read_pickle('sst_lfa14C_method2.pkl')
    ...
    df_14A.reset_index(inplace=True)
    df_14B.reset_index(inplace=True)
    df_14C.reset_index(inplace=True)
    ...
    df_14A.set_index('time', inplace=True)
    df_14B.set_index('time', inplace=True)
    df_14C.set_index('time', inplace=True)
    ...
    df_S_daily = df_NE.resample('D').mean().sst
    df_A_daily = df_A.resample('D').mean().sst
    df_14A_daily = df_14A.resample('D').mean().sst
    df_14B_daily = df_14B.resample('D').mean().sst
    df_14C_daily = df_14C.resample('D').mean().sst
    ...
    df_S_daily.dropna(inplace=True)
    df_A_daily.dropna(inplace=True)
    df_14A_daily.dropna(inplace=True)
    df_14B_daily.dropna(inplace=True)
    df_14C_daily.dropna(inplace=True)
    df_14A_daily.to_csv('SST_lfa14A_daily.csv', float_format='%.2f')
    df_14B_daily.to_csv('SST_lfa14B_daily.csv', float_format='%.2f')
    df_14C_daily.to_csv('SST_lfa14C_daily.csv', float_format='%.2f')

    # Monthly averages
    df_14A_monthly = df_14A.resample('M').mean().sst
    df_14B_monthly = df_14B.resample('M').mean().sst
    df_14C_monthly = df_14C.resample('M').mean().sst
    df_14A_monthly.to_csv('SST_lfa14A_monthly.csv', float_format='%.2f')
    df_14B_monthly.to_csv('SST_lfa14B_monthly.csv', float_format='%.2f')
    df_14C_monthly.to_csv('SST_lfa14C_monthly.csv', float_format='%.2f')
