...
# add hake
df_cpue = pd.concat([df_hake, df_cpue], axis=1)
...
if series1:
    ...
    PC_CPUE = pd.concat([pc_so075.T, pc_botT.T, pc_tem075.T, pc_eke.T, pc_mld.T, pc_phyc.T, pc_chl075.T, df_anom], axis=1)
...
ax = plt.gca()
XTICKS = np.arange(0.5, 45.5, 1)
plt.xticks(XTICKS)
ax.set_xticklabels(LABELS)
fig.set_size_inches(w=20,h=14)
if series1:
    fig_name = 'Correlation_PC-CPUE_v4.png'
else:
    fig_name = 'Correlation_PC-CPUE_v4_series2.png'
