...
propay = [30, 60]
ax11.plot(propax, propay, '--', color='k', linewidth=2)
ax11.text(XLIM1[0], YLIM1[1], "b  ", horizontalalignment='right', verticalalignment='center', fontsize=14, color='k', fontweight='bold')
