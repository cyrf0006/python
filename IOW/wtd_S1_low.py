...
ax1.text(XLIM[0], 65, r'  $\rm U_{near} ( m s^{-1})$', horizontalalignment='left', verticalalignment='center', fontsize=14, color='k')
#ax1.plot([storm, storm], [19, 72], '--k')
#ax1.plot([storm2, storm2], [19, 72], '--k')
# add patch
...
ax2.text(XLIM[0], 65, r'  $\rm V_{near} ( m s^{-1})$', horizontalalignment='left', verticalalignment='center', fontsize=14, color='k')
#ax2.plot([storm, storm], [19, 72], '--k')
#ax2.plot([storm2, storm2], [19, 72], '--k')
...
ax3.text(XLIM[0], 65, r'  $\rm U_{sub} ( m s^{-1})$', horizontalalignment='left', verticalalignment='center', fontsize=14, color='k')
#ax3.plot([storm, storm], [19, 72], '--k')
#ax3.plot([storm2, storm2], [19, 72], '--k')
...
ax4.text(XLIM[0], 65, r'  $\rm V_{sub} ( m s^{-1})$', horizontalalignment='left', verticalalignment='center', fontsize=14, color='k')
#ax4.plot([storm, storm], [19, 72], '--k')
#ax4.plot([storm2, storm2], [19, 72], '--k')
