...
XLIM = [pd.Timestamp('2010-03-01 15:30:00'), pd.Timestamp('2010-03-01 17:30:00')]
fig_name = 'S1_adcp_zoom2.pdf'
...
min15 = dates.HourLocator(interval=15)
dfmt = dates.DateFormatter('%H:%M')
min1 = dates.MinuteLocator(interval=1)
...
ct = plt.contour(Tbin.index, Tbin.columns, Tbin.T, levelsT, colors='k', linewidths=2)
plt.colorbar(c)
...
ct = plt.contour(Tbin.index, Tbin.columns, Tbin.T, levelsT, colors='k', linewidths=02)
plt.colorbar(c)
